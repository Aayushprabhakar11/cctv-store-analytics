...
# Higher stride = fewer frames processed = more accurate unique counts for short clips
FRAME_STRIDE = int(os.environ.get("PIPELINE_FRAME_STRIDE", "15"))

# Higher threshold = only confident person detections pass through
CONF_THRESHOLD = float(os.environ.get("PIPELINE_CONF_THRESHOLD", "0.55"))
...
DWELL_INTERVAL_MS = int(os.environ.get("PIPELINE_DWELL_INTERVAL_MS", "60000"))
